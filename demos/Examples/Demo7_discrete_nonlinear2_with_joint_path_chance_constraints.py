"""
Demo 7: Tutorial 7
Type: discrete models with joint path chance constraints
...
x1 = x0 + f(x0,u,p).
This demo has joint path chance constraints, mean value path constraints, input constraints and input change 
constraints.
Tha joint path chance constraints calculate the probability of the constraints
has to be respeceted over the whole evaluated points, i.e., the probability that the constraint
has no violation over the time steps.
...
from doepy.constraints import ControlDeltaConstraint, JointChanceStateConstraint, ConstantMeanStateConstraint
...
bds = Ms[0].z_bounds
z_const = []
z_const.append(JointChanceStateConstraint(bds,conf=d_conf))
